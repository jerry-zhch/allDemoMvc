 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://www.juntaihc.com/", wsdlLocation = "http://127.0.0.1:8060/Service.asmx")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://www.juntaihc.com/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8060/Service.asmx");
    ...
    public ServiceSoap getServiceSoap() {
        return super.getPort(new QName("http://www.juntaihc.com/", "ServiceSoap"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.juntaihc.com/", "ServiceSoap"), ServiceSoap.class, features);
    }
